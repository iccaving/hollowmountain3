...
\end{pagemap}
	...
	\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
		...
		\frame{
		 ...
		 \caption{An impressive natural ampitheatre, near where the old \passage[|see{Tolminski Migovec}]{Mig} path arrives after its terrifying ascent of the face of \passage[|see{Tolminski Migovec}]{Mig} -- near \passage[cave]{M24}. --- Jack Hare}
