\section{The death of Jailbreak}
	...
	\begin{figure*}[t!]
		...
		\end{subfigure}
	\caption{
		\emph{(a)} A plan of \passage[cave]{Jailbreak} cave, drawn in the 2013 scanned logbook \pen{Rhys Tyers}
		\emph{(b)} An artist's impression on digging and subsequently killing the leads in \passage[cave]{Jailbreak} \pen{Tanguy Racine}
		}
