...
Nearly a decade later, in 1982, and after significant digging effort, M16 was broken into. A 100m to the SW of \passage{M2}, and a stone's throw from the massive, but unfortunately choked M1 gaping entrance, a small, choss filled tube led to the start of a long pitch series, extending down to -547m. The jewel of the cave (apart from its unusual depth for time which marked it as the deepest in Slovenia) was the final chamber \passage{Galaktika}, the largest underground volume yet under \passage{Tolminski Migove}c. 
