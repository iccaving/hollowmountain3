...
Then followed the usual shuttle between the tent and the bivi, gathering all the essentials for the coming trip: food, water, gear. Finally it was time to stride across the \passage{Plateau}, to the start of the abseil. 
...
As far as I knew, the boot might have found its way down to the \passage{Tolminka}. Still, I offered to climb down to have a look for it, over the first 150 metres of scree that led to the \passage[path]{Kuk} path. As it happened, the missing item had not gone far and Maffi found it himself, but I had time to climb down to the path and up again before realising that. We spent a surprisingly long time trying to figure out what each other meant: 
...
\caption{Maffi went to \passage{Primadona} via the 1500m contour path which links \passage{Planina Kal} with \passage{Krn} on the other side of the valley. Tanguy abseiled down the wester cliffs of the \passage{Plateau} to meet with him at the cave entrance \pic{Jarvist Frost}}
\label{forest}
\end{figure*}
...
\caption{The partially protected traverse between \passage{Monatip} and \passage{Primadona} is a journey for the faithful \pic{Jarvist Frost}}
\label{traverse}
\end{figure}
...
\frame{\includegraphics[width =\linewidth ]{"images/2016/tanguy-sewer-2016/ben_cloaca_maxima_3".jpg}}
\caption{}
\end{subfigure}
\hfill
\begin{subfigure}{0.301\textwidth}
\frame{\includegraphics[width = \linewidth]{"images/2016/tanguy-sewer-2016/ben_aven_cloaca_maxima".jpg}}
\caption{}
\end{subfigure}
\vspace{1em}

\caption{\emph{(a)} Ben Richards on the lower \passage{Cloaca Maxima} crawlway
\emph{(b)} Ben Richards on the upper \passage{Cloaca Maxima} crawl
\emph{(c)} Black concretions on the walls of the crawl
\emph{(d)}The \passage{Cloaca Maxima} high aven \pic{Tanguy Racine}
...
We opted for the larger, obvious way on, which bent up at a 3\,m climb, then carried on to reach a T-junction. We chose the downstream end, quickly finding another T-junction, where the passage widened, and opened up. To the right and down, a short section with a deepening rift broke out on the eastern wall of a high, oblong aven (\fref{fig:cloaca_maxima}). Clean washed boulders on the floor. The sound of drips. 

I whistled in astonishment at our find: the size of the aven was remarkable after such a long time crawling through the tube: near $20\times10$\,m cross section at the bottom, and the ceiling lost over 40\,m higher up. On the western wall, and near the base of the aven, the phreatic conduit beckoned: I had a quick look, and satisfied that it didn't choke completely after a couple of metres turned around. In the aven, it looked like there could be a twin shaft, connected by a fault plane to the south. This could be accessed by climbing on a boulder pile and bridging the shaft walls where they came close together.
...
Clare, as it happened was ensnared in my trap. I thought that the proximity of the lead to the surface might entice other people, but Kenneth was, for some reason not caving anymore. Will and Arun were planning to push \passage{Cattlegrid}, leaving Dave Wilson to convince. He followed us all the way to the cliff abseil, but turned around when the ropes to reach \passage{Monatip} gave out. So it was Clare and I going in. 
