\section{Back to the Hollow Mountain}
     \begin{marginfigure}
        ...
        \caption{The east face of Krn, with a small alp and limestone spur containing \protect\passage{Polo\v{s}ka Jama} \pic{Tanguy Racine}} \label{Krn}
    \end{marginfigure}
   \vspace{30pt}
    \begin{marginfigure}
        \centering
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
  ...
  \hfill
    ...
    \caption{
    \emph{(a)} A panorama of Migovec and the \protect\passage[pass]{\v{S}krbina} ridge in the background
north of Tolmin 
