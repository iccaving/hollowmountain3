\section{Back to the Hollow Mountain}
     \begin{marginfigure}
        ...
        \caption{The east face of Krn, with a small alp and limestone spur containing \protect\passage{Polo\v{s}ka Jama}} \label{Krn}
    \end{marginfigure}
   \vspace{30pt}
    \begin{marginfigure}
        \centering
        \frame{\includegraphics[width=\linewidth]{"images/2016/back-to-the-hollow-mountain-2016/tolminka_gorge".jpg}}
        \caption{ The \protect\passage{Tolminka Korita}, a series of gorges carved by the \protect\passage{Tolminka} and \protect\passage{Zadla\v{z}cica} rivers } \label{Tolminka Gorge}
    \end{marginfigure}
...
\emph{b} The success of another expedition can be read on the cavers' glowing smiles, at the \protect\passage{Migovec Trig Point} --- Tanguy Racine
    \emph{c} Mixing carries, coffee and beer at the \protect\passage{Sheperd's Hut}: Tiasa, Maffi, Will S, Tanguy and Kenneth --- Arun Paul
