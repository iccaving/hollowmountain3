\section{Back to the Hollow Mountain}
   ...
   \vspace{30pt}
    \begin{marginfigure}
        ...
        \caption{ The \protect\passage{Tolminska Korita}, a series of gorges carved by the \protect\passage{Tolminka} and \protect\passage{Zadla\v{s}\v{c}ica} rivers \pic{Tanguy Racine}} \label{Tolminka Gorge}
    \end{marginfigure}
