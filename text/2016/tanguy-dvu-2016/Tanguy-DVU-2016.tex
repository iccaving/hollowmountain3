...
\end{subfigure}
    ...
    \textit{(a)} Huge boulder collapse in the \protect\passage{Déjà Vu} chamber.  
     ...
     \textit{(c)} The  \protect\passage{Déja Vu}/ \protect\passage{TTT} junction, where 'leopard spots' are preserved--- Jarvist Frost }
\end{figure*}
...
\centering
 ...
 \caption*{Plan view of the \protect\passage{Ajdov\v{s}\v{c}ina} extensions over the top of the \protect\passage{Déjà Vu} passage. Slovenian National Grid ESPG 3794}
 \label{Déjà Vu inset}
\end{marginfigure}
