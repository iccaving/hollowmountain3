...
\end{subfigure}
    ...
    \end{subfigure}
    \caption{
    \textit{(a)} Large boulders have collapsed, making a huge pile in the centre of the main chamber in \protect\passage{Déja Vu}.  
     ...
     \textit{(c)} The junction between  \protect\passage{Déja Vu} extension and the main \protect\passage{TTT} branch, where 'leopard spots' are preserved--- Jarvist Frost }
\end{figure*}
