...
\caption[TTT pitch (grade 1)]{A grade 1 survey of \protect\passage{TTT} pitch and the \protect\passage{Déjà Vu} junction below --- Tanguy Racine}
...
\end{subfigure}
    ...
    \textit{(a)} Huge boulder collapse in the \protect\passage{Déjà Vu} chamber.  
     ...
     \textit{(c)} The  \protect\passage{Déjà Vu}/ \protect\passage{TTT} junction, where `leopard spots' are preserved--- Jarvist Frost }
\end{figure*}
