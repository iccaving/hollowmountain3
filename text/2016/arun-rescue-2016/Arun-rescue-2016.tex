...
\margininbox{Call Out expires}{Will and Arun's ETA of 8.00pm went past.  \newline At around 9.00pm we started the fire in the bivi and welcomed the Skalars, sharing the drinks. 10.00pm was fast approaching by now and Kenneth reminded me of the group's callout. Something along the lines of `should we reset it to 7.00am' was muttered. Callouts are definitive, and only function if taken seriously in all circumstances. I put \textit{vitaminski} in a bottle and Kenneth and I went to the top of the \passage{SRT Wall} to look out for lights on the ascent.  \name{Tanguy Racine}}{\logbook}
    ...
    \begin{figure*}[t!]
        ...
        \end{subfigure}
            ...
            \textit{(c)} The rescue team with stretcher secured on cowstails move through horizontal sections of Primadona \pic{Maks Merela, deputy leader of the Slovenian Cave Rescue (JZS)}}
    \end{figure*}
