...
\begin{pagefigure}
      ...
      \centering
       ...
       \label{Panorama}
  \caption{ A  panorama of the glacial cirque which makes up the head of Gardeners' World valley, the whale bone and the main valley between \passage[mountain]{Tolminksi Migovec} and \passage[mountain]{Vhr na Skrbino} --- Tim Child }
\end{pagefigure}
