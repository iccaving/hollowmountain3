...
\label{Rhys Skrbina}
\caption{Rhys Tyers stands at the summit of \protect\passage{Vrh Nad Skrbino} --- Dave Kirkpatrick}
\end{marginfigure}
...
\caption{Rigging one of the new finds in Monatip--- Iztok Mo\v{z}ir}
\end{marginfigure}
