...
\caption{(b)}
\end{subfigure}
\caption{\protect\passage{Big Rock Candy Mountain} \emph{(a)} is a twin pitch located at the end of \protect\passage{Friendship Gallery}, over which it is now possible to traverse \emph{(b)} to reach the \protect\passage{Cuckoo's Nest} extensions \pic{Jarvist Frost}}
\label{none}
\end{pagefigure}
