...
\label{}
\caption{Camp \protect\passage{X-Ray} in full swing \pic{Iztok Mo\v{z}ir}}
\end{marginfigure}
...
\label{}
\caption{Rhys hard at work \pic{Kate Smith}}
\end{figure*}
...
\caption{}
\end{subfigure}
\caption{\protect\passage{Big Rock Candy Mountain} ( named after the massive boulder in on the left) is a twin pitch located at the end of \protect\passage{Friendship Gallery}, over which it is now possible to traverse to reach the \protect\passage{Cuckoo's Nest} extensions \pic{Jarvist Frost}}
\label{none}
\end{pagefigure}
