...
\node [name-dest] (box){%
    ...
    \textit{I undersigned Tanguy Racine, self-respecting cook and amateur gastronome declare my papillae ‘blown away’ by the onion soup and chips which were left for us to eat.}
...
\caption*{The \protect\passage{Zadla\v{z}cica} river, just upstream of hydro-electrical station offers a profusion of sunlit riffles and pools --- Tanguy Racine}
\end{subfigure}
\end{figure*}
