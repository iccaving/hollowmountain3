...
\end{subfigure}
    ...
    \emph{(b)} Dave Wilson and Jack Hare illuminate the wide pitch base where \passage{Galerija} and \passage{Smer0} passages branch off \pic{Rhys Tyers}}
\end{figure*}
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
 \centering
\frame{\includegraphics[width = \linewidth]{"images/2017/rhys-hallelujah-2017/fenestrator".png}}
\caption[Fenestrator plan (grade 1)]{The topology of the \passage{Fenestrator} branch \pen{Rhys Tyers, surface logbook}}
\end{survey}
...
\centering
 ...
 \caption[Fenestrator branch]{Plan view of the \protect\passage{Hallelujah} branch. Slovenian National Grid ESPG 3794}
...
\margininbox{Plumber's Paradise}{
    \begin{citemize}
    \item Rhys Tyers
    \item Ben Honan
    \item Clare Tan
...
\end{subfigure}
    ...
    \emph{b} Rebecca Diss and Dave Kirkpatrik standing in \passage{Plumbers' Paradise} passage \pic{Rhys Tyers}}
\end{figure*}
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
     \centering
        ...
        \caption{ Rebecca Diss negotiates a climb above the stream canyon in \protect\passage{Hallelujah} \pic{Rhys Tyers}} \label{Diss Hallelujah}
\end{marginfigure} 
...
\centering
 ...
 \caption[Sweet Baby Jesus]{Plan view of the \protect\passage{Hallelujah} branch. Slovenian National Grid ESPG 3794}
