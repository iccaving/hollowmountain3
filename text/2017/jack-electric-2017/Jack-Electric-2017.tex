...
\end{subfigure}
\caption{\emph{(a)} Jack Hare and Dave 'Davie Dubz' Wilson at the bottom of the \protect\passage{Electric Dreams} main pitch \emph{(b)} Dave Wilson standing over the clear pool attempts to push a very tight rift --- Rhys Tyers}
\label{new figure}
\end{figure*}
...
Reluctantly, I dropped my rope to the bottom to check it could reach, and then prussiked out, leaving it there. I figured if it was \passage[|see{Hall of the Mountain King}]{HotMK} then someone else might find it there and confirm where I’d dropped into.
