...
\centering
    ...
    \end{subfigure}
    \caption{
    \textit{(a)} The \protect\passage[valley]{V08} valley with a cave riddled southern wall and massive scree on a foggy day --- Jarvist Frost
     \textit{(b)} Rigging the abseil down to \passage[cave]{Gondolin} cave from the \protect\passage[valley]{V08} valley --- Jack Hare }
\end{figure*}
...
\begin{pagesurvey}
    ...
    \caption[Gondolin plan and elevation]{Extended Elevation and plan view of \protect\passage[cave]{Gondolin}}
    \label{}
\end{pagesurvey}
...
\end{subfigure}
    ...
    \textit{(a)} Ben Honan surveying at the permanent survey station (bottom of \passage[cave]{Gondolin})
     ...
     \textit{(c)} Although promising looking, the bottom of \passage[cave]{Gondolin} was choked with frost shattered rock piles --- Jack Hare}
\end{pagefigure}
