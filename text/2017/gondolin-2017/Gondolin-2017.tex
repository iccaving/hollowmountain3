...
\centering
 ...
 \caption{Mink cave, a short alcove eventually connected to Hare cave thanks to Jack Hare and Rhys Tyers' digging effort. A magnificent 10m through-trip \pic{Jarvist Frost}}
 \label{mink gps}
\end{marginfigure}
...
The next day, Jack joined us for the pushing of `\passage[cave]{Gondolin}', the `Hidden Stone' realm from Tolkien's legendary middle earth. Also, doesn't `doline' mean valley in Slovene? I challenge anyone else to make sindaro-slovene puns. 
