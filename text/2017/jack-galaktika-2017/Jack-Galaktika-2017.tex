...
\label{Ta Mokra}
\caption{  \protect\passage[pitch]{Ta Mokra} pitch on the way to \protect\passage[chamber]{Galaktika} --- Rhys Tyers}
\end{marginfigure}
...
\label{Ta Mokra}
\caption{   \protect\passage[chamber]{Galaktika} chamber is accessed by a large pendulum across the pitch. --- Rhys Tyers}
\end{marginfigure}
