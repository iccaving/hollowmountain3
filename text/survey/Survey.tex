...
An concrete example is the production of hillshades, or artificial illumination maps from a digital elevation model, which, as we have seen on maps \ref{map overlay}, \ref{map area n} and \ref{map area K}
