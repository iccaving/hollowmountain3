...
\begin{marginfigure}
	...
	\centering	\frame{\includegraphics[width=\linewidth]{images/maps-of-mig/minotaur_rift_jarvist.jpg}} 
  	\caption{The \protect\passage{Minotaur Rift} was one of the findings of 2010, and one key element of the fossil passage series that ended connecting \protect\passage{Vrtnarija} and \protect\passage{Sysmig} \pic{Jarvist Frost}} \label{fig:minotaur_rift}
	\end{marginfigure}
...
\vspace{-200pt}
	...
	\frame{\includegraphics[width=\linewidth]{images/overview/tolminka_cecilia.jpg}} 
  	\caption{Precipitation in the high limestone ranges finds its way underground and resurges as two stunningly blue streams: the \protect\passage[river]{Tolminka} and \protect\passage[river]{Zadla\v{z}\v{c}ica} rivers, photographed near their confluence \pic{Cecilia Kan}}
	\end{marginfigure}
