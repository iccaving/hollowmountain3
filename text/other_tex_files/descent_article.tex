...
\paragraph{The early days} The JSPDT members initiated exploration around the \passage{Migovec plateau} in 1974 with the logging of 17 caves entrances (M1 through to m17). There were two notable findings: \passage{M2} - pushed from 1974 to 1978 - and \passage{M16} -pushed from 1982 and 1985, which at -350m and -547m were the then deepest caves of Yugoslavia, and contained a huge underground cavern named Galaktika. After 1985, the JSPDT lacked the man power to work on Migovec, which was left virtually untouched for another decade. \sidenote{A French and, subsequently a British club visited \protect\passage{Migovec} during that time. No major discoveries were made by either expedition, leading to the abandonment of the leads}

\paragraph{1994-2000} The JSPDT welcomed the first ICCC expedition to \passage{Migovec} in 1994, which saw minor discoveries under \passage{Tolminski Migovec}, including \passage{M18} (cave of the \passage{Torn T-Shirt}), then 78m deep. The return visit in 1995 saw significant horizontal development (\passage{NCB passage}) and the set-up of a shallow underground camp (\passage{Club Mig}). This paved the way for several breakthroughs the following year and connection of \passage{M2}, \passage{M18} and \passage{M16}. \passage{Sistem Migovec} was born.

The following years saw a consistent probing of nearly ten different shaft series accessed by one single trunk route. Of these, only one (XXX-Sajeta) accessed deeper levels. Underground camping at Hotel Tolminka
\paragraph{2000-2006} Vrtnarija or Gardeners' World entrance was dug out
