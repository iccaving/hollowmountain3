...
This new setting paved the way for several breakthroughs the following year and connection of \passage{M2}, \passage{M18} and \passage{M16}.  \passage{Sistem Migovec} was born... The following years saw a consistent probing of half a dozen different shaft series accessed by one single trunk route. Of these, only one (\passage{XXX}-\passage{Sajeta}) accessed deeper levels. \passage[camp]{Hotel Tolminka} was chosen as underground camp.
...
\vspace{-200pt}
	...
	\frame{\includegraphics[width=\linewidth]{images/overview/tolminka_cecilia.jpg}} 
  	\caption{Storm clouds from the Adriatic sea break over the high limestone ranges and the resulting precipitation finds its way underground and resurges as two stunningly blue streams: the \protect\passage[river]{Tolminka} and \protect\passage[river]{Zadla\v{s}\v{c}ica} rivers, photographed near their confluence \pic{Cecilia Kan}}
	\end{marginfigure}
...
\begin{pagemap}
\includegraphics[width = \linewidth]{images/maps-of-mig/triglav_topomap.png}
\caption{A topographical map of the Triglav National Park area, 1996 Slovene National Grid (EPSG:3794)}
\end{pagemap}
