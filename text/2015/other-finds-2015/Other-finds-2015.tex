...
\passage{X-Ray} and finished the bolt climbs up \passage{Strap on the Nitro}, eventually surveying 200\,m of crawls (named \passage{Andrea Bocelli}) before breaking out into a larger, more complex area of rifts, which at the time took lots of water from an ongoing storm. These extensions at the far west of \passage{Vrtnarija} came extremely close to \passage{Wonderstuff} in the old system, but failure to survey the last 100m or so of passage due to the adverse conditions means the possible connection was called off. It is yet to be surveyed as of 2017.
...
\end{subfigure}
    ...
    \emph{a}  Alex Seaton by the ice and rubble choke at the bottom of the snow filled shaft
     ...
     \emph{c}  Riggin the snow slop into the cave proper, Oliver Myerscough on the rope \pic{Cecilia Kan}}
\end{pagefigure}
