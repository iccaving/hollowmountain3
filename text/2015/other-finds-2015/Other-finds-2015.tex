...
\recipecorner{Couscous for 10}{This will take about 30 mins:
\begin{citemize}
\item Melt 2 tbsp margarine/oil in pan
\item Add 500 g couscous
\item  Cook for 2 mins
\item Add 800 ml boiling water
\item Bring back to boil
\item Boil for 2/3 mins – should resemble a slurry
\item Leave for 10 mins. Fluff.
\end{citemize}
}

\subsection{Closing a loop beyond Sic Semper Tyrannis}
At the beginning of the expedition, Rhys Tyers and James O'Hanlon carried on in the \passage{Jericho} rift where it had been left the year before. Dropping ten metres, they found a southerly continuation of the passage, and after several climbs following the howling draught they reached an apex, where ways on both level and upwards beckoned. Snubbing the exposed climb, they carried on over a muddy slope to an area of breakdown. 

This was later passed by Rhys Tyers and Tanguy Racine, yielding many metres of walking passage in the \passage{Meridian Way}. The open lead received further attention when Clare Tan and Oliver Myerscough pushed further south, past a constriction (\passage{Choke-a-Bloke}) into more near horizontal gallery (\passage{Empty Quarter}. There, they sighted a dormouse specimen. \bignote{The far end of the galleries lie some 300-350\,m from the surface at the closest approach, and are found near vertically underneath \passage{Coincidence cave} }.

The pair also connected the northern end of \passage{Meridian Way} to the \passage{Pleasure Palace}, through a 300\,m long crawl. They observed a couple of leads branching off, but they were not investigated due to time constraints. The connection thus forms a 1.2\,km roundtrip beginning in \passage{Sic Semper Tyrannis}.

\subsection{Atlantis and beyond}
Rhys Tyers and Ben Honan explored the streamway issuing from the far chamber in \emph{Sic Semper Tyrannis}, a trip which coincided with a particularly severe flood pulse --- Tanguy Racine and William French reported similarly high or rising water levels in the \passage{Esoterica} and \passage{A Pun Too Far} streamways. They found a sump and its bypass before carrying on into a deeply cut meandering canyon(\emph{Davy Jone's Locker}). Their push ended where the waterfall disappeared into a noisy pitch below. Further traversing led to a pitch later descended by Rhys Tyers and Tanguy Racine. On this particular trip, the waterfall of \passage{Brezno Slapov} could be heard rumbling as far as from the \passage{Sic Semper Tyrannis} junction. 

The pair also paid a visit to \passage{We're Not Alone}, discovered back in 2012 by Tetley and Dave Wilson. The small passage had then seemed to continue past a flat out constriction, around a sharp left hand bend. \bignote{Rhys Tyers managed to slither past the squeeze (helmet off) and confirm that the passage indeed continues. To this day, this tight, but tantalising lead remains unpushed.}
...
\subsection{Agartha}
Dave Kirkpatrick and Jim Evans investigated the upstream end of \passage{Push Your Luck}, found about one hour from camp \passage{X-Ray}. Owing to some confusion regarding the actual pushing front (Rhys and Tanguy had left PSS's just above stream level, not in the high level muddy phreatic) and an ill-working compass, there is some doubt as to the status of this lead. The pair found the stream forking where two similar sized inlets came together. Pushing one of them upstream, they hit a too-tight waterfall and turned back, tying their survey to the middle PSS (stn 39) of \passage{Push Your Luck}. In the high level crawl passage, they spotted a likely lead in modest chamber but left for others to investigate.



\subsection{Andrea Bocelli - climbs off Strap on the Nitro}
Further to the experimental drone flight up the \passage{Nitro} aven - by Jarvist Frost and Rhys Tyers in 2014 - Jarvist Frost and Connor Roe made progress on the aven bolt climb, discovering \passage{Dinner Service}, a large boulder floored chamber. Another smaller, higher aven taking significant draught remained unclimbed. The presence of delicate mud and calcite formations was noted on the higher ledges of the climb.

Towards the end of the expedition, Grega Maffi and Tja\v{s}a Rutar both camped at 
\passage{X-Ray} and finished the bolt climbs up \passage{Strap on the Nitro}, eventually surveying 200\,m of crawls (named \passage{Andrea Bocelli}) before breaking out into a larger, more complex area of rifts, which at the time took lots of water from an ongoing storm. These extensions at the far west of \passage{Vrtnarija} came extremely close to \passage{Wonderstuff} in the old system, but failure to survey the last 100\,m or so of passage due to the adverse conditions means the possible connection was called off. It is yet to be surveyed as of 2017.

\subsection{Surface exploration}
Alex Seaton and Cecilia Kan spotted a likely snow plugged shaft not far north from the \passage{Bivi}. Due to fluctuating snow and ice levels from year to year the investigation of such ice filled shakeholes remains a vital part of the annual ICCC expeditions. 
...
\centering
  ...
  \caption[Area K]{Topographic map of the little \passage{Podrta Gora Plateau}, \passage{Area K} Slovenian National Grid ESPG 3794}
...
\centering
    \begin{subfigure}[t]{0.565\textwidth}
        ...
        \caption{(a)} \label{At the bottom of the lead}
    \end{subfigure}
        \hfill
...
\end{subfigure}
    ...
    \emph{(a)}  Alex Seaton by the ice and rubble choke at the bottom of the snow filled shaft
     ...
     \emph{(c)}  Rigging the snow slope into the cave proper, Oliver Myerscough on the rope \pic{Cecilia Kan}}
\end{pagefigure}
...
\caption{The team at the end of the 2015 expedition. From left to right: the Klobu\v{c}ar family, Janet Cotter, Oliver Myerscough, William French, Rosanna Nichols, Rhys Tyers, Chris McDonnel, Cecilia Kan, David Wilson, Tanguy Racine \pic{Rhys Tyers}}
\label{}
\end{pagefigure}
