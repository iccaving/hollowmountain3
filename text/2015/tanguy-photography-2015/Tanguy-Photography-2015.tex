...
`You intend to take some?'
    ...
    \begin{survey*}[t!]
        ...
        \caption[Touching the Void - grade 1]{An extended elevation view of \protect\passage{Helm's Deep} chamber and adjoining \protect\passage{Touching the Void} extensions ---Rhys Tyers, underground logbook}
        \label{helms deep}
 ...
 Following the water, past the sump bypass flat out crawl, to the undescended pitch Rhys and Ben had found earlier. At the head, I put in a bolt, backed-up by two sling anchors and tied up a Y-hang knot. \bignote{When I looked at the remaining length of rope available to descend, I let out a loud curse}. Either rope we'd brought was too short on its own after the knots were tied.
