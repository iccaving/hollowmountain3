...
\begin{marginfigure}
	...
	\caption{A musical night in the Bivi, with Ben Honan and James O'Hanlon \pic{Jarvist Frost}}
	\label{Falls Road}
\end{marginfigure}
...
\begin{marginsurvey}
	...
	\caption{Plan view of \protect\passage{Falls Road}}
	\label{Falls Road}
\end{marginsurvey}
...
\begin{pagefigure}
\centering
\frame{\includegraphics[width= \textwidth]{images/2015/ben-2015/cecila_bivi.jpg}}
\caption{Sitting around the stone circle, Alex Seaton, Oliver Myerscough, Tanguy Racine and Rhys Tyers take part in typical \passage{Bivi} activities \pic{Cecilia Kan}} \label{people in the bivi}
\end{pagefigure}
