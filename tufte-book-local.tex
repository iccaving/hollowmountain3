...
\newcommand{\name}[1]{\vskip2ex\nopagebreak{\raggedleft\large\sffamily\textbf{#1}\par} \index[aut]{#1|BH} \rmfamily}
...
\tikzstyle{recipe} = [   draw=parchment!80, 
                    fill=parchment!20, 
                    thick,
                    rectangle, 
                    rounded corners, 
...
\newcommand{\helmet}{\protect\includegraphics[height = 4ex]{images/little_insets/helmet.png}}
\newcommand{\recipecorner}[2]{
                        ...
                        \node [recipe] (box){%
                            ...
                            \vspace{5pt}
                            \sffamily\textcolor{dparchment}{#2}
                            \end{minipage}
                        };
